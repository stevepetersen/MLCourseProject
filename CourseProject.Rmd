...
For a Random Forest classifier, the OOB (Out-of-bag) error estimate is an attempt to estimate the out-of-sample error.  Let's look at the average for all models/classes:
